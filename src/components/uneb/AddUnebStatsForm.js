...
const AddUnebStatsForm = () => {
  ...
  const handleSubmit = async (values) => {
    try {
      ...
      console.error("Error saving exam statistics:", error);
    }
  };
  ...
  const formik = useFormik({
    initialValues: {
      level: "",
      totalStudents: "",
      gradeStatistics: [{ grade: "", numberOfStudents: "" }],
      bestStudents: [{ name: "", gradeScore: "", imageUrl: "" }],
    },
...
export default AddUnebStatsForm;
